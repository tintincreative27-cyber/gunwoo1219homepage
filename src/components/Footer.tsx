        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground text-sm mb-4 max-w-md">
              Premier B2G defense procurement platform. Trusted by allied nations 
              for secure, compliant access to advanced military systems.
            </p>
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-4">
              All inquiries processed through secure channels. 
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-xs text-muted-foreground">
              © 2024 StratLink Defense Solutions. All rights reserved.
            </p>
            <div className="flex items-center gap-4 text-xs text-muted-foreground">
              <span>ITAR Compliant</span>
              <span>•</span>
              <span>EAR Registered</span>
              <span>•</span>
              <span>DFARS Certified</span>
            </div>
          </div>
        </div>
      </div>
