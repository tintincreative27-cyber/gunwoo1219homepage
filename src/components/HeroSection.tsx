      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-foreground mb-6 leading-tight animate-fade-in" style={{ animationDelay: "0.1s" }}>
            Global Defense Nexus
            <span className="block text-accent mt-2">Secure & Strategic</span>
          </h1>

          {/* Sub-headline */}
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            Premier B2G procurement platform trusted by allied nations. 
            Access cutting-edge defense systems with military-grade security.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10 animate-fade-in" style={{ animationDelay: "0.4s" }}>
            <div className="trust-badge px-4 py-2 rounded-lg flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-foreground">ITAR Compliant</span>
            </div>
            <div className="trust-badge px-4 py-2 rounded-lg flex items-center gap-2">
              <Shield className="w-5 h-5 text-accent" />
              <span className="text-sm font-medium text-foreground">NATO Standard</span>
            </div>
            <div className="trust-badge px-4 py-2 rounded-lg flex items-center gap-2">
              <Lock className="w-5 h-5 text-accent" />
              <span className="text-sm font-medium text-foreground">Cyber-Secure</span>
            </div>
          </div>
        </div>
      </div>
